...
def main():
    ...
    trainer = pl.Trainer.from_argparse_args(
        ...
        profiler=profiler,
        # resume_from_checkpoint='/mnt/lustre/xietao/deepmatcher/score_dk_final/outdoor-ds-840-bs=32/version_1/checkpoints/epoch=29-auc@5=0.553-auc@10=0.715-auc@20=0.831.ckpt'
        )
